      ...
      <div ref="sideNav" class="bm-menu">
        ...
        <nav class="bm-item-list">
          <div class="r_list">
            <p
              class="r_keyword"
              v-for="(tag, idx) in userInfo.myTag"
              :key="idx"
            >
              {{ tag }}
            </p>
          ...
          <ul id="mlist">
            ...
            <li>
              <router-link class="ml" id="Home" to="/home">HOME</router-link>
            </li>
            <li>
              <router-link class="ml" id="exhibition" to="/exhibit"
            ...
            <li>
              <router-link class="ml" id="feed" to="/feed"
                >NEWSFEED</router-link
              >
            </li>
            <li>
              <router-link class="ml" id="scrapbook" to="/scrap"
                >SCRAPBOOK</router-link
              >
            </li>
    ...
    onClickProfile() {
      ...
      if (this.$route.name == 'UserFeedList') {
        if (this.$route.params.userId != this.user.userId)
          this.$emit('seeFeedList', this.user.userId);
      } else {

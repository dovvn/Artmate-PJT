...
gantt
    ...
    UI/UX(전시회)   :crit,2021-02-04,2d
    UCC컨셉, 사전조사   :done,after p2,6h
    Jira,Git,MM연동   :done,after p2,6h
    Jenkins & 자동 배포 :crit, 2021-02-02,3d
    발표PPT 제작: crit,2021-02-04,1d
    
    section Frontend
    SubⅡ SNS 미완성 보완          :crit, 2021-02-01, 4d
    SubⅡ 반응형 보완          :crit, 2021-02-01, 4d
    피드 3D 전시 페이지   :,2021-02-05,6d
    전시회 페이지   :,2021-02-05,2d
    스크랩북 페이지   :,2021-02-06,2d

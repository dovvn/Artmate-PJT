...
gantt
    ...
    피드 3D 전시 페이지   :active,2021-02-06,9d
    지도페이지(카카오맵 API 적용):active,2021-02-07, 8d
    전시회 메인페이지   :active,2021-02-08,7d
    전시회 상세페이지   :active,2021-02-07,4d
    스크랩북 페이지   :active,2021-02-08,5d
    메인 페이지 추가기능   :,2021-02-14,3d
    소개 페이지   :,2021-02-15,2d
    에러 해결   :,2021-02-15,4d
    ...
    전시회 조회 기능:active,2021-02-05,6d
    추가 공공데이터API 가져오기          :active, p1, 2021-02-09, 2d
    네이버 검색 크롤링     :active, 2021-02-09,2d
    실시간 전시회 알림 기능(웹소켓)          :active, 2021-02-08, 3d
    에러 해결   :,2021-02-15,4d
```
